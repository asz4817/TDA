...
import MusicSumbissionSystem from "../components/MusicSumbissionSystem";
					...
					<div className="">
						<div className="w-[80%] grid md:grid-cols-2 mx-auto">
							<div className="space-y-4 z-50 md:py-[10vh] pb-[2vh]">
								...
								>
									Deadline: Saturday, February 14th, 2026
								</p>
								<p
									className=""
									style={{
