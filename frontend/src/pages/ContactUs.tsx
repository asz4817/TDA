					...
					<div className="z-[3] relative">
						<div className="w-[75%] grid md:grid-cols-2 mx-auto">
							<div className="space-y-2 md:space-y-4 z-50 mt-20 md:mt-5 pb-3 pr-2">
								...
								>
									For any inquiries, or if you're an event
									organizer looking for an awesome performance
									for your event, we'd love to hear from you!
						...
						<div className="">
							<div className="w-[75%] grid md:grid-cols-2 mx-auto">
								<div className="space-y-2 md:space-y-4 z-50 mt-20 md:mt-5 pb-3 pr-2">
									...
									>
										For any inquiries, or if you're an event
										organizer looking for an awesome
										performance for your event, we'd love to
										hear from you! Reach out and let's
										connect.
									</p>
									<div className="justify-self-start">
										<Socials />
