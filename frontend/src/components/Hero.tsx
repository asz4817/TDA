	...
	return (
		<div>
			<div className="hidden md:block">
				<section
					className="relative w-screen mb-10"
					style={{
				...
				>
					<section className="relative w-full h-screen bg-cover mb-10 scrollbar-hide">
						{/* Main content */}
						<div className="relative z-10 flex flex-col justify-end h-full px-[12%] pb-[4%]">
							{/* Bottom Left */}
							<div
								className="absolute right-[14%] bottom-[7%] fixed"
								style={{
							...
							<div
								className="absolute bottom-[11%] right-[14%] fixed"
								style={{
									// transform: scrolling ? "translateX(0)" : "translateX(500%)",
									// transition: "transform 0.5s ease-out",
									opacity: scrolling ? 1 : 0,
				...
				>
					...
					<div
						style={{
							...
							translate:
								scrollTop >= scrollMax * 0.5 ? "0 0" : "0 40%",
						}}
					>
						<PerformanceCards />
					</div>
